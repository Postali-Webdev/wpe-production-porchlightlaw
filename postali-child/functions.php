 ...
 */
	...
	function postali_child() {
		...
		wp_register_style( 'icomoon-fonts', 'https://cdn.icomoon.io/152819/PorchlightIcons/style-cf.css?l4vviv', array() );
    ...
    function klf_acf_input_admin_footer() { ?>
        ...
        args.palettes = ['#ffffff', '#000000','f5f5f5','666666','3f7cb1','292F5F','eaa722']
	...
	// Populate GForm hidden field with Cookie
	// add_filter( 'gform_field_value_first_touch_url', 'populate_first_touch_url' );
	// function populate_first_touch_url( $value ) {
	// 	return $_COOKIE['first_touch_url'];
	// }
